...
const SignUp = () => {
    const [userData, setUserData] = useState({ username: '', email: '', password: '', confirmEmail: '', confirmPassword: '' });
    const { username, password, email, confirmEmail, confirmPassword } = userData;
        ...
        <>
            <section className='my-99'>
                <main className='auth-container max-w-md mx-auto'>
                    ...
                    <button onClick={() => _signup()} className="bg-red-500 text-white w-full mb-18 px-32 py-10 rounded-5 transition-all hover:bg-red-600 relative top-0 hover:top-px" >Sign Up</button>
