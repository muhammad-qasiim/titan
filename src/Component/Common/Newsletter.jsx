            ...
            <section className="bg-gray-800">
                ...
                <section className="container mx-auto px-24 lg:px-99 py-60 border-b border-gray-500">
                    <section className="text-center mb-44">
                        ...
                        <p className="mb-12 text-16 text-white">Join our mailing list to stay in the loop with our newest feature releases, NFT drops, and tips and tricks for navigating Titan.</p>
                        ...
                        <section className="flex items-start justify-center gap-3 flex-wrap">
                            {
                                communitylinks?.map(link => (
                                    <div className="grid place-content-center cursor-pointer bg-gray-600 transition-all hover:bg-gray-800 hover:text-red-500 text-24 w-48 h-48 rounded-5">
                                        {link}
                                    </div>
                                ))
                            }
