                ...
                <footer className='text-center w-full py-14 px-12'>
                    <Link className="w-full" to="/single_nft">
                        ...
                        <div className="flex items-center justify-between gap-2 mt-4 mb-8">
                            <h6 className="flex items-center gap-2 justify-center text-md leading-relaxed text-gray-800 cursor-pointer font-medium transition-all hover:text-gray-900"> Billionaireclub_LLC <GoVerified className="text-blue-500 text-16" /> </h6>
